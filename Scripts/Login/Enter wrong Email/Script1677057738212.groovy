...
'Input Email'
WebUI.setText(findTestObject('Object Repository/Login/txt_Email'), 'ngoctrang@gmail.com')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Login/msg_error'), 0)

'Take screenshot after logging in successfully'
WebUI.takeScreenshot('Screenshot/Login/unsuccessfully_enter_wrong_email.png')
