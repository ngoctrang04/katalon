...
'input search'
WebUI.setText(findTestObject('Object Repository/Register/input_txt',[('text'):'q']), 'MacBook')

'Click search'
WebUI.click(findTestObject('Object Repository/Add_to_cart/btn_search'))
...
if (m==true) {
	...
	if (product_name1 == product_name2) {
		WebUI.takeScreenshot(((((('Screenshot/Add to cart/'+'/Success/')+ Date)+ '/')+ Time) + ' By Search')+'.png')
	}
}
else {
		WebUI.takeScreenshot(((((('Screenshot/Add to cart/'+'/Error/')+ Date)+ '/')+ Time) + ' By Search')+'.png')
}
'Close browser'
WebUI.closeBrowser()
