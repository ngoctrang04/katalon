...
if (m==true) {
	...
	if (product_name1 == product_name2) {
		WebUI.takeScreenshot(((((('Screenshot/Add to cart/'+'/Success/')+ Date)+ '/')+ Time) + ' From home screen')+'.png')
	}
}
else {
		WebUI.takeScreenshot(((((('Screenshot/Add to cart/'+'/Error/')+ Date)+ '/')+ Time) + ' From home screen')+'.png')
}
'Close browser'
WebUI.closeBrowser()
