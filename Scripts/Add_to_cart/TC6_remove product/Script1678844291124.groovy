...
WebUI.click(findTestObject('Object Repository/Add_to_cart/btn_remove'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Add_to_cart/msg_cart empty'), 2)
