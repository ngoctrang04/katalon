...
'Input Email'
WebUI.setText(findTestObject('Object Repository/Register/txt_Email'), 'truongtrinh123@gmail.com')
...
'Verify successful registration message displayed'
WebUI.verifyElementText(findTestObject('Object Repository/Register/msg_RegisterComplete'),
	'Your registration completed')

'Take screenshot after register successfully'
WebUI.takeScreenshot('Screenshot/Register/TC5.png')
